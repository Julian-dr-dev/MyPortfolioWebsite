                ...
                <div className="z-30 basis-2/5 mt-12 md:mt-32">
                    ...
                    >
                        ...
                        <p className="mt-14 mb-7 text-sm text-center md:text-start">
                            A motivated and inquisitive software engineer with a passion for developing eloquent software solutions
                            using an array of versatile computational technologies.
                        </p>
